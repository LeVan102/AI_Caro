Chươnng trình game caro tictoctoe sử dụng  pygame trong python và engine AI dựa trên thuật toán minimax, cắt tỉa alpha-beta và giới hạn độ sâu
...
- Phân tích: 
   ...
   + Mỗi vị trí kết thúc trò chơi(nút lá) sẽ gán một trọng số. vd: 10 win, 0 hòa, -10 lose. Tại mỗi nút cũng có một trọng số tương ứng được xác định bằng một cách nào đó. Dựa vào cây trò chơi này, ta có thể tìm nước đi tốt để giành chiến thắng.
...
*Chi tiết trò chơi:
		Dự trên một ma trận 2 chiêu với trạng  thái ban đầu là 0
		Sau mỗi lần chơi , giá trị của các ô trong ma trận thay đổi : người chới là 1 , máy chới là 2
		Trạng thái tính điểm nút lá: thắng 10,thua -10, hòa 0
		Chương trình sử dụng thư viện pygame, numpy trong python
Chúc năng của game:
	Bấm r để restart
